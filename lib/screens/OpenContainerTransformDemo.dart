...
class _OpenContainerTransformDemoState extends State<Test> {
              ...
              closedBuilder: (BuildContext _, VoidCallback openContainer) {
                return ListTile(
                  leading: Image.network(
                    "https://spoonacular.com/recipeImages/jalapeno-burger-2-98730.jpg",
                    width: 40,
                  ),
                  onTap: openContainer,
                  title: Text('List item ${index + 1}'),
                  subtitle: const Text('Secondary text BANTERERER'),
                );
              },
            );
          }),
